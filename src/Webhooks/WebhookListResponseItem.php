...
use ModerationAPI\Webhooks\WebhookListResponseItem\EventType;
use ModerationAPI\Webhooks\WebhookListResponseItem\PayloadVersion;

/**
 * @phpstan-type WebhookListResponseItemShape = array{
 *   id: string,
 *   createdAt: string,
 ...
 * }
 */
final class WebhookListResponseItem implements BaseModel
{
    /** @use SdkModel<WebhookListResponseItemShape> */
    use SdkModel;
    ...
    /**
     * `new WebhookListResponseItem()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WebhookListResponseItem::with(
     *   id: ...,
     *   createdAt: ...,
     *   eventTypes: ...,
     *   name: ...,
