...
/**
 * @phpstan-type IllicitGamblingShape = array{
 *   id: 'illicit_gambling', flag: bool, threshold?: float|null
 * }
 */
final class IllicitGambling implements BaseModel
{
    /** @use SdkModel<IllicitGamblingShape> */
    use SdkModel;
    ...
    /**
     * `new IllicitGambling()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * IllicitGambling::with(flag: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new IllicitGambling)->withFlag(...)
     * ```
     */
