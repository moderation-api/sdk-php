...
use ModerationAPI\Actions\ActionNewResponse\Position;
...
final class ActionNewResponse implements BaseModel, ResponseConverter
{
    ...
    /**
     * `new ActionNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ActionNewResponse::with(
     *   id: ...,
     *   builtIn: ...,
     *   createdAt: ...,
     *   filterInQueueIds: ...,
