...
use ModerationAPI\Actions\ActionListResponseItem\Position;
use ModerationAPI\Actions\ActionListResponseItem\PossibleValue;
...
/**
 * @phpstan-import-type PossibleValueShape from \ModerationAPI\Actions\ActionListResponseItem\PossibleValue
 * @phpstan-import-type WebhookShape from \ModerationAPI\Actions\ActionListResponseItem\Webhook
 *
 * @phpstan-type ActionListResponseItemShape = array{
 *   id: string,
 *   builtIn: bool|null,
 *   createdAt: string,
 ...
 * }
 */
final class ActionListResponseItem implements BaseModel
{
    /** @use SdkModel<ActionListResponseItemShape> */
    use SdkModel;
    ...
    /**
     * `new ActionListResponseItem()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ActionListResponseItem::with(
     *   id: ...,
     *   builtIn: ...,
     *   createdAt: ...,
     *   filterInQueueIDs: ...,
