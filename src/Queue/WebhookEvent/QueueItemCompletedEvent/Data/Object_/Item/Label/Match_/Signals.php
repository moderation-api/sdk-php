...
namespace ModerationAPI\Queue\WebhookEvent\QueueItemCompletedEvent\Data\Object_\Item\Label\Match_;

use ModerationAPI\Core\Attributes\Required;
use ModerationAPI\Core\Concerns\SdkModel;
use ModerationAPI\Core\Contracts\BaseModel;
use ModerationAPI\Queue\WebhookEvent\QueueItemCompletedEvent\Data\Object_\Item\Label\Match_\Signals\BrandImpersonation;

/**
 * @phpstan-import-type BrandImpersonationShape from \ModerationAPI\Queue\WebhookEvent\QueueItemCompletedEvent\Data\Object_\Item\Label\Match_\Signals\BrandImpersonation
 *
 * @phpstan-type SignalsShape = array{
 *   botProtection: bool|null,
 *   brandImpersonation: null|BrandImpersonation|BrandImpersonationShape,
 *   domainAgeDays: float|null,
 *   finalURL: string|null,
 *   hasEmailSetup: bool|null,
 *   hasSuspiciousCharacters: bool,
 *   isLinkShortener: bool,
 *   isReported: bool,
 *   redirectCount: float|null,
 * }
 */
final class Signals implements BaseModel
{
    ...
    public function withDomainAgeDays(?float $domainAgeDays): self
    {
        $self = clone $this;
        $self['domainAgeDays'] = $domainAgeDays;
    ...
    public function withRedirectCount(?float $redirectCount): self
    {
        $self = clone $this;
        $self['redirectCount'] = $redirectCount;
